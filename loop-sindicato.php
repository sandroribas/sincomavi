<?php
query_posts('category_name=sindicato-destaques&showposts=2');
if ( have_posts() ) : while ( have_posts() ) : the_post(); //resumindo, se existrem posts, mostre-os?>
<div <?php post_class(); ?>>
	<?php the_post_thumbnail('post-thumbnails'); ?>
    <div class="titulopg"><h1 class="titulo-pg"><a style="color: inherit" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title();?></a></h1></div><!--fim do titulopg-->
    <?php the_content(); ?> 
