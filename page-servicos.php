    		...
    		<div id="conteudo-servicos">
                ...
                <div id="grupo_construir">
                	<div id="cont-constrhuir">
                        ...
                        <div class="left">
                        	<h1>Atividades ajudam no desenvolvimento do setor</h1>
                        	<p>Em agosto de 1995 foi criado, com o apoio do SINCOMAVI, o Grupo Informal de Profissionais de Recursos Humanos do Comércio de São Paulo (Grupo ConstRHuir). O objetivo era a troca de informações e o desenvolvimento do setor. O trabalho no início envolvia somente profissionais de empresas dos varejos representados pela entidade. No entanto, com o amadurecimento do projeto, resultados obtidos e a repercussão das atividades, representantes de outros segmentos do comércio começaram a participar de eventos e discussões. Hoje, o Grupo ConstRHuir conta com a presença de profissionais das seguintes empresas: C&C, Tintas MC, Center Castilho, Galeto’s, Habib’s, Spoleto, Fórum, Hering, Renner, Zogbi, Drogaria São Paulo, Drogaria Antares, Drogaverde, Fast Shop, Saraiva, Banco Alfa, Grupo Silvio Santos, Evadin, Associação Comercial de São Paulo, entre.
                            </p>
                        </div><!--fim da left-->
                        <div class="right">
